...
开箱即用、生产就绪的 React Native 快速启动模板。

基于单一代码库，构建 **iOS**、**Android** 和 **Web** 跨平台应用。
...
- **[React Native Reanimated](https://docs.swmansion.com/react-native-reanimated/)** — 高性能 60fps 动画
- **[@gorhom/bottom-sheet](https://gorhom.github.io/react-native-bottom-sheet/)** — 流畅的底部弹出交互
...
- **测试** — Jest + React Native Testing Library，支持覆盖率报告
...
| 工具     | `expo-clipboard`, `expo-linear-gradient`, `react-native-svg`            |
