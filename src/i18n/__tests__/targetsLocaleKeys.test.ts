...
const REQUIRED_KEYS = [
  ...
  "targets.addTag",
  "targets.groups.manageMembership",
  "targets.groups.targetLabel",
  "targets.groups.quickCreate",
  "targets.search.primaryTarget",
  "targets.groups.deleteTitle",
  "targets.groups.deleteConfirm",
  "targets.batch.deleteSelected",
  "targets.batch.deleteConfirm",
  "targets.batch.setStatus",
  "targets.batch.favoriteSelected",
  "targets.batch.unfavoriteSelected",
  "targets.scanSummaryTitle",
  "targets.scanSummaryScanned",
  "targets.scanSummaryAdded",
  "targets.scanSummaryUpdated",
  "targets.scanSummarySkipped",
  "sessions.detectSummaryTitle",
  "sessions.detectSummaryDetected",
  "sessions.detectSummaryNew",
  "sessions.detectSummaryUpdated",
  "sessions.detectSummaryMerged",
  "sessions.detectSummarySkipped",
  "sessions.noSelectedSessions",
  "sessions.batchSync",
  "sessions.batchRefresh",
  "sessions.batchUnsync",
  "sessions.batchSyncSessions",
  "sessions.batchRefreshSessions",
  "sessions.batchUnsyncSessions",
  "sessions.batchSummaryTotal",
  "sessions.batchSummarySuccess",
  "sessions.batchSummarySkipped",
  "sessions.batchSummaryFailed",
  "sessions.batchSummaryUpdated",
  "sessions.batchSummaryCleared",
  "sessions.batchSummaryUnchanged",
  "sessions.batchSummaryErrors",
