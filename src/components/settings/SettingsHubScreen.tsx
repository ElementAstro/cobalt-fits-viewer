...
const CATEGORIES: CategoryInfo[] = [
  ...
  },
  {
    ...
    searchKeyHints: [
      ...
      "settings.videoMediaTitle",
      "settings.videoCoreEnabled",
      "settings.videoProcessingEnabled",
      "settings.defaultVideoProfile",
      "settings.defaultVideoTargetPreset",
      "settings.performance",
      "settings.defaultExportFormat",
    ],
    searchTerms: ["sigma", "alignment", "compose", "converter", "debounce", "video", "audio"],
  },
  {
    key: "observation",
